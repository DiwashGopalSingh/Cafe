...
function LocationFallback() {
  return <div className="relative h-[380px] overflow-hidden bg-[#e9e0d2] md:h-[500px]">
    ...
    <div className="absolute left-1/2 top-[48%] w-[min(78%,290px)] -translate-x-1/2 -translate-y-1/2 bg-[#fffaf2]/95 p-5 text-center shadow-[0_16px_32px_rgba(86,61,43,0.14)]"><span className="mx-auto inline-flex h-9 w-9 items-center justify-center rounded-full border border-[#b65e3c]/55 p-1"><img src="/images/diwash_mark.png" alt="" className="h-full w-full object-contain" /></span><p className="mt-3 font-body text-[10px] font-extrabold tracking-[0.2em] text-[#b65e3c]">DIWASH'S CAFÉ</p><p className="mt-2 font-display text-3xl text-[#2d241f]">Bhagwati Tole-3</p><p className="mt-1 font-body text-xs text-[#77665a]">look for the mark</p></div>
